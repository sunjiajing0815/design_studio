...
$(document).ready(function () {
    ...
    //Set up original version music box
    ...
    //Retrieve musicbox seq number from URL
    ...
    //Generate note from: http://musicbox.grit.it/
...
function loadOriginSong(iSongNr) {
    //load music notes from:http://musicbox.grit.it/
    var sampleSong;
    console.log("+++>old version "+iSongNr);
    switch (iSongNr) {
        case 1: //
...
function loadMusicImg(iSongNr){
    //load music image from server based on the music seq number
    console.log("./img/mb1"+iSongNr+".jpg");

    $(".music-image img").attr("src","./img/notes"+iSongNr+".png");
}
function o_cleardoos(){
    //clear the staff from:http://musicbox.grit.it/
...
function o_speeldoos(){
    //Play the music from: http://musicbox.grit.it/
...
function playOriginTime(){
    //Play time sound control and style control modified based on:http://musicbox.grit.it/
...
function o_playDone(){
    //CLear up after play and print out music record, modified based on: http://musicbox.grit.it/
    //ttimer++;
